        ...
        >
            ...
            <div className="absolute inset-0 overflow-hidden">
                <img 
                    ...
                    opacity-45 scale-105 transition-opacity duration-700"
                />
                ...
                >
                    ...
                    <div className="hidden sm:flex items-center justify-between gap-3 mt-1 w-full opacity-90 text-(--text-main)">
                        ...
                        <div className="flex items-center gap-4 w-24 justify-end shrink-0">
                            <button 
                                onClick={handlePrev} 
                                className="p-3 hover:bg-gray-200/60 dark:hover:bg-gray-500/40 cursor-pointer rounded-full"
                            >
